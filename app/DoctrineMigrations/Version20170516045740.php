 ...
 */
class Version20170516045740 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE pagos (codigopago INT AUTO_INCREMENT NOT NULL, codigousuario INT DEFAULT NULL, importe NUMERIC(10, 0) DEFAULT NULL, fecha DATETIME DEFAULT NULL, INDEX fk_pagos_codigousuario_idx (codigousuario), PRIMARY KEY(codigopago)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('ALTER TABLE favoritos ADD CONSTRAINT FK_1E86887F21F506FC FOREIGN KEY (codigousuariofavorito) REFERENCES usuarios (codigousuario) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE pagos ADD CONSTRAINT FK_DA9B0DFFA5B4F832 FOREIGN KEY (codigousuario) REFERENCES usuarios (codigousuario) ON DELETE CASCADE');
    }
